<template>
  <div>
    <!-- Contact Area Start -->
    <section id="contact" class="contact-area contact-area-3">
        <!-- Google map Start-->
    ...
    <div class="contact-form-area position-relative">
        <div class="container">
            <div class="row contact-form-address-wrapper">
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    ...
                    <div class="contact-address">
                        <ul>
                            ...
                            <li><span><i class="flaticon-e-mail-envelope"></i></span>contact@mail.com</li>
                            <li><span><i class="flaticon-call"></i></span>+123 (214) 457 888</li>
                        </ul>
                    </div>
                    <!--contact-address-->
                </div>
